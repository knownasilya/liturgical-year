...
[tag](https://github.com/knownasilya/liturgical-year/tags) are then pushed to github to preserve the history of what we've published and when.

**Generating A Release**

Once the commit has been tagged, our script publishes the tag as a new [Github Release](https://github.com/knownasilya/liturgical-year/releases) with the associated release notes.
