...
[![lerna version](https://img.shields.io/github/package-json/dependency-version/knownasilya/liturgical-year/dev/lerna)](https://lerna.js.org/)
[![pnpm version](https://img.shields.io/github/package-json/packageManager/knownasilya/liturgical-year)](https://pnpm.io/)
[![Generate Release Candidate](https://github.com/knownasilya/liturgical-year/actions/workflows/release.yml/badge.svg?event=workflow_dispatch)](https://github.com/knownasilya/liturgical-year/actions/workflows/release.yml)
...
```sh
git clone git@github.com:knownasilya/liturgical-year.git
```
